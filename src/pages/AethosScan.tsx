...
import { ArrowLeft, Box, Hash, Activity, Shield, Coins, Search } from "lucide-react";
                      ...
                      return (
                        <motion.tr key={proof.id} initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.6 + i * 0.1 }} className="hover:bg-primary/5 transition-colors group">
                          <td className="px-6 py-4 flex items-center gap-2">
                            ...
                            <span className="text-primary truncate max-w-[100px] md:max-w-[180px] cursor-pointer hover:underline">{proof.tx_hash}</span>
                          </td>
